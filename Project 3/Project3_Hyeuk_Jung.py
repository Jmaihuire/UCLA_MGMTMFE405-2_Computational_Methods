...
#t = 3; n = 3000; sqrtdt = sqrt(t/n)
#y0 = exp(1/3*sqrtdt*np.random.normal(0, 1, 1) + 3/4*np.random.normal(0, 1, 1))
...
plt.show()
# d) Plots and comment
print('Compared to other two plots, the points using base 2 and 4 shows strong correlations.')
